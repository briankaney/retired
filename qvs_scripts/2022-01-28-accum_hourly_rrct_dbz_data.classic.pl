...
if($argc==0)  {
  print "\n\nUsage:\n";
  print "   accum_hourly_rrct_dbz_data.pl real\n";
  exit 0;
  }
...
$in_radcal_data_dir  = "/nfsdata/realtime/fetched/rrct/comparisons_dBZ/";
...
for($i=0;$i<$num_pairs;++$i)  {
  ...
  $monthly_file = $out_radcal_data_dir.$year."/".$month."/dbz/".$pair_name."_".$year.$month."_Refl_Comparison";
  if(-e $new_file)  {
